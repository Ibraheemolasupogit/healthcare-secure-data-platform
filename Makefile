...
governance-reference:
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli governance generate-evidence --output-dir governance/reference --overwrite
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli governance verify-evidence --output-dir governance/reference

governance-static:
	PYTHONPATH=src pytest tests/unit/test_governance_milestone14.py

deployment-reference:
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli deployment generate-evidence --output-dir deployment/reference --overwrite
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli deployment verify-evidence --output-dir deployment/reference
...
operations-reference:
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli operations generate-evidence --output-dir operations/reference --overwrite
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli operations verify-evidence --output-dir operations/reference

operations-static:
	PYTHONPATH=src pytest tests/unit/test_operations_milestone17.py

portfolio-reference:
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli demo generate-evidence --output-dir portfolio/reference --overwrite
	PYTHONPATH=src $(PYTHON) -m healthcare_platform.cli demo verify-evidence --output-dir portfolio/reference
