...
Validate Milestone 16 recovery controls locally:
...
PYTHONPATH=src python -m healthcare_platform.cli recovery generate-evidence \
  --output-dir recovery/reference --overwrite
PYTHONPATH=src python -m healthcare_platform.cli recovery verify-evidence \
  --output-dir recovery/reference
