...
| Component | Owns | Does not own | Milestone 1 status |
|---|---|---|---|
...
| Python | Synthetic generation, boundary validation, ingestion helpers, local diagnostics | Warehouse-scale transformations | Installable safe diagnostic CLI |
