...
| Governance registry | Central classifications, personas, purposes, access policies, consent controls, masking/row/object/export/retention/audit policies, service identities and compliance-claim controls | Replacing Snowflake RBAC, dbt ownership, Airflow orchestration, Dataiku workflows, feature definitions, BI semantics or live enforcement | M14 registry and local simulation implemented |
