...
Milestone 14 adds a central persona and access-policy registry that maps to this RBAC
design. It does not replace Snowflake role ownership or deploy live role assignments.
